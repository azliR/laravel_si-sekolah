                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    @else
                                                        <button class="btn btn-primary mr-2" data-toggle="modal"
                                                                ...
                                                                class="nav-icon fas fa-paper-plane"></i>&nbsp; Kirim
                                                            Jawaban
                                                        </button>
                                                    @endif
                                                    <a href="{{ route('siswa.tugas.download', $tugas->id) }}"
                                                       class="btn btn-success btn-sm align-self-center"><i
                                                            class="nav-icon fas fa-download"></i> &nbsp; Download Tugas</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @empty
